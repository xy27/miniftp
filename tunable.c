...
const char *tunable_listen_address = NULL;       // 这是一个指针变量，全局变量
// const char *tunable_listen_address;           // ok 全局变量默认初始化为0 等效于NULL
// const char *tunable_listen_address = -1;      // Segmentation fault
